...
@section('content')
    ...
    <div class="row justify-content-center" style="padding-bottom: 10%;">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" class="testing-update-record-model">
                <div class="card-body" id="updateBody">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary"><a href="{{route('testing')}}">Back</a></button>
                        <button type="button" class="btn btn-primary updateTesting">Update</button>
                    </div>
                  </form>
                </div>
            </div>
   ...
   <script src="{{ url('js/testing/update_testing.js') }}" ></script>
