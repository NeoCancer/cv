...
// for switch map
    ...
    firebase.database().ref().on('value', function (snapshot) {   
        ...
        map.addSource('facilities', {'type': 'geojson',
            'data': places
        });
              ...
              const input = document.createElement('input');
                ...
                label.setAttribute('for', 'taguig-city');
                label.style.cssText = 'background-color:#800000';
                label.textContent = "All Layer";
        ...
        map.on('click', 'taguig-city', (e) => {
            new mapboxgl.Popup()
            .setLngLat(e.lngLat)
            .setHTML(e.features[0].properties.barangay)
            .addTo(map);
            });
        ...
        for (const feature of places.features) {
            ...
            if (!map.getLayer(layerID)) {
                 ...
                 if (layerID == "hospitals") {
                    ...
                    'layout': {
                        'icon-image': 'hospital1', // reference the image
                        'icon-size': 0.06,
