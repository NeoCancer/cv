...
//    });
   ...
   map.on('load', function(e) {
    ...
    $('#submitTesting').on('click', function (e) {
        ...
        var t_addr = values[1].value;
        var t_contact = values[2].value;
        var t_email = values[3].value;
        var t_capacity = values[4].value;
        var t_lon = values[5].value;
        var t_lat = values[6].value;
        var testingID = lastIndex + 1;

       

        firebase.database().ref('testings/' + testingID).set({
            t_name: t_name,
            t_addr: t_addr,
